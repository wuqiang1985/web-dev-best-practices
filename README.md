...
```
/install wuqiang1985/web-dev-best-practices
```
...
|---|---|---|---|
| 安装方式 | `/install` + `/web-dev:configure` | `./install.sh` | 手动 `cp` |
...
本插件通过 `web-dev:` 前缀与 ECC（`everything-claude-code:`）完全隔离：

| 功能 | 本插件 | ECC |
|------|--------|-----|
| 代码审查 | `/web-dev:review` | `/everything-claude-code:code-review` |
| TDD | `/web-dev:tdd` | `/everything-claude-code:tdd` |
| 规划 | `/web-dev:plan` | `/everything-claude-code:plan` |
| 安全扫描 | `/web-dev:security-scan` | `/everything-claude-code:security-scan` |
...
| 操作 | 命令 |
|------|------|
| 安装插件 | `/install wuqiang1985/web-dev-best-practices` |
